# nvim-treesitter-queries-yang

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-yang/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-yang/actions/workflows/validate.yml)

Neovim tree-sitter queries for **yang**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-yang",
...
- [ ] Changes are scoped to `yang` — do not include files for other languages
